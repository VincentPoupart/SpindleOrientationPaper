...
pp = PlotlyJS.plot([plot1, plot2, plot3, plot4], layout3_5)# plot both the surface and the centrosome
resizefigtime = 0.75
...
savefig(pp, "M:\\Labbe\\Vincent Poupart\\Poster 2023-02-23\\Gonad_3D_Julia\\ellipsoid_alone.svg")